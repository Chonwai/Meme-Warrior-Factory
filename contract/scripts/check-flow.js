...
async function main() {
  ...
  console.log("Checking Flow deployment status...");
  ...
  console.log(`- Token: ${FLOW_EXPLORER_URL}/address/${deployData.token}`);
  console.log(`- Factory: ${FLOW_EXPLORER_URL}/address/${deployData.factory}`);
  console.log(`- Reward: ${FLOW_EXPLORER_URL}/address/${deployData.reward}`);
}
